        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('vocabularyUpdate',$vocabulary->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        ">
                                        @foreach($days as $day)
                                            <option @if($day->id == $vocabulary->day_id) selected @endif value="{{ $day->id }}">{{ $day->name }}</option>
                                            @endforeach
                                            </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="translate" id="word"
                                               value="{{ old('translate',$vocabulary->translate) }}"
