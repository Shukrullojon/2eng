                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('grammerIndex') }}">Grammer</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('grammerUpdate',$grammer->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        ">
                                        @foreach($days as $day)
                                            <option @if($day->id == $grammer->day_id) selected @endif value="{{ $day->id }}">{{ $day->name }}</option>
                                            @endforeach
                                            </select>
